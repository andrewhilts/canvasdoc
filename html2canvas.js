...
NodeParser.prototype.generateListNumber = {
 ...
 NodeParser.prototype.renderBullet = function(container, bounds){
	...
	var dir = getComputedStyle(container.parent.node).direction;
 	var x = bounds.left - padding;
 	if(dir == "rtl"){
 		x = container.parent.bounds.right + (padding*2);
 	}
 	switch(type){
 			case 'decimal':
 		case "decimal-leading-zero":
 		...
 		case 'lower-roman':
 			...
 			var x2 = bounds.left - padding;
		 	if(dir == "rtl"){
		 		x2 = container.parent.bounds.right + (padding*2);
 				value = '.'+value;
		 	}
		 	else{
		 		value += ".";
		 	}
 			x2 -= c2d.measureText(value).width;
 			c2d.fillText(value, x2, bounds.bottom);
 			break;
 		case 'square':
